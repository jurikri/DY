...
path3 = 'E:\\dy\\dy_THcelldetection\\semi_XY_save\\post2\\predict\\'; msFunction.createFolder(path3) # new label save path

# path3 = 'E:\\dy\\dy_THcelldetection\\semi_XY_save\\post1\\predict\\'; msFunction.createFolder(path3)

weight_savepath = 'E:\\dy\\dy_THcelldetection\\semi_XY_save\\post1\\weightsave_7\\' # exsit predict file path
